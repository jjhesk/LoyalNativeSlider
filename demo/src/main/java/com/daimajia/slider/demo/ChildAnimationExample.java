...
public class ChildAnimationExample implements BaseAnimationInterface {
    ...
    public void onPrepareCurrentItemLeaveScreen(View current) {
        View descriptionLayout = current.findViewById(com.hkm.slider.R.id.description_layout);
        if(descriptionLayout!=null){
            current.findViewById(com.hkm.slider.R.id.description_layout).setVisibility(View.INVISIBLE);
        }
    ...
    public void onPrepareNextItemShowInScreen(View next) {
        View descriptionLayout = next.findViewById(com.hkm.slider.R.id.description_layout);
        if(descriptionLayout!=null){
            next.findViewById(com.hkm.slider.R.id.description_layout).setVisibility(View.INVISIBLE);
        }
    ...
    public void onNextItemAppear(View view) {
        ...
        View descriptionLayout = view.findViewById(com.hkm.slider.R.id.description_layout);
        if(descriptionLayout!=null){
            view.findViewById(com.hkm.slider.R.id.description_layout).setVisibility(View.VISIBLE);
